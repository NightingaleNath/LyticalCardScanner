package com.codelytical.creditcardscanner.widgets;
...
import com.codelytical.creditcardscanner.R;
import com.codelytical.creditcardscanner.model.CardDetails;
import com.codelytical.creditcardscanner.utils.CardUtils;
...
public class CardDetectionStateView extends View {
    ...
    public synchronized void setRecognitionResult(CardDetails result) {
        ...
        if (!TextUtils.isEmpty(result.getExpirationMonth()) || !TextUtils.isEmpty(result.getExpirationYear()) ) {
            mRecognitionResultDate = result.getExpirationMonth() + '/' + result.getExpirationYear();
        } else {
    ...
    public synchronized void clearRecognitionResult() {
        if (DBG) Log.d(TAG, "clearRecognitionResult() called");

        // Reset recognition results to null or default values
        mRecognitionResultCardNumber = null;
        mRecognitionResultDate = null;
